...
Route::middleware(['auth'])->group(function () {
    Route::middleware(['subscribed'])->group(function () {
        ...
        Route::middleware(['owner'])->group(function () {
            ...
            Route::get('competitions/{competition}/import/summary', [App\Http\Controllers\CompetitionController::class, 'showSummary'])->name('competitions.showSummary'); // NOWA TRASA
